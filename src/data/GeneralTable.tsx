...
export const GeneralTable: React.FC<React.ComponentProps<'div'> & { addMethod?: () => void; selectedItemsCount: number }> = ({
  children,
  addMethod,
  selectedItemsCount,
  ...props
  ...
  <div
    ...
    {...props}
  >
    <div className="flex-1 w-full flex flex-row overflow-hidden rounded-lg">{children}</div>
